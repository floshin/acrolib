...
I would like to compare different periodisation methods with different approaches to diet. There is...
* a very strict diet plan, where you only eat precisely what is written on the plan, which requires a lot of planning, but may be preferred by some people. This strict method is almost guaranteed to lead to success, if followed strictly. But following it strictly can be difficult and can feel restrictive.  
* there is so called flexible dieting, where the macro nutrients are defined, but one can freely choose the food as long as he covers his macros in the end and doesn't exceed his needs. This flexible approach works better for many people. It also is almost guaranteed to lead to success in regard to the desired body recomposition, but may contain some downsides in regard to health, since it doesn't matter what one eats, just that its the correct amount of macro nutrients. A strict plan may plan in more variety. There are ways around that obviously, like also including micro nutrient targets or by just more stricty planning in a specific amount of "healthy" options while keeping other areas flexible and so on. 
* lastly there is what I would describe as "intuitive" dieting, which is what most people do and it is also what works easiest for most people. It works insofar as that most people usually eat rather intuitively and hold their weight thereby. It is only problematic if they want to gain or loose weight and establish a new norm as athletes etc. In such cases, the success of an intuitive diet depends on how good ones intuition is or how well one follows ones intuition instead of making nutritional decisions based on other factors, such as appetite, emotional craving etc. 

In training it is very similar. 
* One can train according to a very strict plan. If the plan is bad, nothing will come out of it or one may as well injure oneself. But if it is good, gets adjusted to the individual needs etc., strict planning can be extremely effective and will almost inevitably lead to results if one strictly follows the plan and trains accordingly.
* Then there is a more flexible approach to programming. Just as in the example above one may only try to get the right amounts of nutrients while being free to choose the food options, in a flexible training programme one may for example have...
  * (strict volume, free exercise selection) a strict number of sets that one aims for per day or per week or per month, but is free to choose the exercises one prefers for the target muscles. Or, a different form of flexible training would be the opposite.
  * (fixed exercises, flexible volume/intensity) strict exercises that one has to do, but is flexible in how much volume he aims for or how intense he trains the muscles etc.
* lastly there is an intuitive training, where one neither has a fixed exercise selection nor a fixed desired volume, intensity or frequency. This can be effective as well or it may lead to constant injuries and problems or simply to no progress whatsoever. 

Independent of all these different approaches there are a few factors that decide over whether or not progress will be made or not and whether or not this progress is sustainable.
...
2. **Balance of Higher and Lower Intensity:** Every form of periodisation involves some sort of higher intensity (pushing harder for strength, but putting much pressure on the body and joints) and lower intensity training (focusing more on musculature, mass building and/or joint health). This can happen on a block basis in form of deload weeks, but it can as well happen in form of lower intensity, higher volume sessions vs. higher intensity, lower volume sessions that switch on a weekly or daily basis in waves. It is important to practice both. Only lower intensity may result in much endurance and healthy joints (if one isn't doing high intensity partner work), but strength will suffer. Only higher intensity may result in much strength, but ones joint health and endurance, cardio-vascular health etc. will suffer. Thus, one has to have both, balance out both. A strict programme can do that, a flexible programme can do that and an intuitive one can do that as well. 
