...
There is...
* ...a very strict diet plan, where you only eat precisely what is written on the plan, which requires a lot of planning, but may be preferred by some people. This strict method is almost guaranteed to lead to success, if the plan is good and if followed strictly. But following it strictly can be difficult and can feel restrictive and creating a good plan requires much knowledge and learning.  
* ...so called flexible dieting, where the macro nutrients are defined, but one can freely choose the food as long as he covers his macros in the end and doesn't exceed his needs. This flexible approach works better for many people. It also is almost guaranteed to lead to success in regard to the desired body recomposition, but may contain some downsides in regard to health, since it doesn't matter what one eats, just that its the correct amount of macro nutrients. A strict plan may plan in more variety. There are ways around that obviously, like also including micro nutrient targets or by just more stricty planning in a specific amount of "healthy" options while keeping other areas flexible and so on. 
* ...lastly what I would describe as "intuitive" dieting, which is what most people do and it is also what works easiest for most people. It works insofar as that most people usually eat rather intuitively and hold their weight thereby. It is only problematic if they want to gain or loose weight and establish a new norm as athletes etc. In such cases, the success of an intuitive diet depends on how good ones intuition is or how well one follows ones intuition instead of making nutritional decisions based on other factors, such as appetite, emotional craving etc. 
...
* Then there is a more flexible approach to programming. Just as in the example above, where one may only try to get the right amounts of nutrients while being free to choose the kind of food, in a flexible training programme one may for example have...
  * a strict number of sets that one aims for per day or per week or per month, but is free to choose the exercises one prefers for the target muscles (strict volume, free exercise selection).
  * a strict set of exercises that one has to do, but is flexible in how much volume he aims for or how intense he trains the muscles etc. (fixed exercises, flexible volume/intensity) 
...
A steady state cycle works in the opposite way: You start with a relatively high, a medium-high intensity (not too high, as that would potentially to hard to endure and positive adaptation may not occur). But now you do not increase this intensity, but you keep doing that very same intensity and the very same volume for some amount of time. That can be a few weeks or it may be some months, just as much as it takes. By just doing that very same thing over and over again, a slow and safe adaptation will occur. The overall volume will be the same, but e.g. one will be able to do the same amount of volume (e.g. X reptitions total) in much less sets. 
