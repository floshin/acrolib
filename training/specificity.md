...
In Acrobatic Gymnastics we have the advantage that many movements/skills that the bases have to perform are very similar to basic weightlifting exercises; it is therefore rather easy to turn the strength training in the preparation of the bases into skill strength. 
...
These were just a few examples in regard to how specificity can be achieved in strength training for the bases for specific motions. 

We could make endless additional examples for other elements and needs. But apart from the pure stability in balance on which we focused above, we may address a few points related to motions and mounts.  


### Base Strength Preparation for Motions, Mounts and Dynamics in Pairs

This rather comprehensive title is well justified, since all of these categories come down to the same basic motion patterns, which is good for bases, as it simplifies their training. 

Almost any kind of mount and dynamics in pairs is either related to a squat, a press, a push-press or a hinge and the necessary strength for it can be build by practicing related lifts. Other, more rare lifts, mostly done by mixed pairs, also include Upright Rows, Swings and such things as One Arm Snatches. A few examples: 
