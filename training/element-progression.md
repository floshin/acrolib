...
I am personally using an approach that I came up with myself. Starting with an exercise which I call "H2H Plank", lying H2H in a Plank position with elevated feet of the top. The Base lies on the floor with the top in H2H. The top has her feet on a box behind the head of the base, at the level of her shoulders, thus holding a plank on the base with elevated feet, while her body is straight. To make it easier it can be started on bent arms of the base: Lying Bent Arm H2H Plank. Or it can be started on straight arms already, but with the box closer to the head of the base; here it can be made simpler by putting the knees or thighs of the top on the box. 

(2b) **H2H Push-ups:** The next step is to perform what I call *H2H Push-ups* in the before mentioned elevated plank position in three different ways. First the partners perform the push-ups in isolation, the base pushes the top up, while the top keeps the arms straight or holds a bent arm push-up position. Then the top performs push-ups while the base keeps the arms straight or bent. Then base and top perform push-ups simultaneously. For the top this exercise has the added benefit of being able to perform the push-ups in a much deeper range than on the floor. Other than that it has similar benefits as ring push-ups due to the additional demands of stabilising the hands of the partner.  

(2c) **H2H at Wall:** When the H2H plank is mastered on straight arms of the base and with only the feet touching the box, the difficulty can be increased further by putting the feet of the top up a wall, while the base lies with the head against the wall. In this position the top will be slightly angled, which is not a problem as long as the overall line is held correctly, as it will only strengthen the shoulders and improve the form. As a next step they perform with the base in a sitting position and finally in a standing position, which allows the base to be closer and closer to the wall and the top to stay more and more vertical.  
...
The H2H Plank has also the advantage that not only the base develops a sense for balance, stability in his shoulders/arms and grip strength, as is the case in F2H, where the top makes no progress towards H2H. In the H2H Plank the top is in H2H from the very beginning, has to grip hard and stabilise her arms, helping the base. 

F2H has the benefit that the base holds the full weight of the top, whereas in H2H Planks only a part of the weight will be on the hands of the base. But by developing the H2H plank gradually into a H2H handstand at the wall, the base carries the full weight as well and can develop the necessary capacity more slowly and safely. 

The wall H2H method is especially effective, as it not only allows a more gradual progress in stability, but it also allows the pair to even practice handstand on their own, independently. 
