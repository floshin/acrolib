...
This "letting it happen" of the girl in mixed pairs is an art in itself and can be extremely difficult or impossible for someone who learned to balance handstands in the first way, with the top-down approach. And it can also be difficult, although much easier to achieve, for someone who has learned to balance in the second way, by the bottom-up approach. Therefore there is a school of acrobatics which, particularly for mixed pair tops, prefers the third way of non-balance. 
