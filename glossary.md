...
* **Acrobatics**, literally "walking on tip toes", generally describes movement that is especially elegant and virtuous, including high degrees of balance, dynamics, flexibility and strength as well as a performance art of displaying these acrobatic moves in the context of shows or competitions in Acrobatic Gymnastics. "Acrobatic" is assigned as an attribute to connote extraordinary physical control.
* **Acrobatic Disciplines** is a wide term that contains many different disciplines, many of which contain external apparata, like in Artistic Gymnastics, such as in Rope-Walking, where you require a rope, Juggling, where you require objects to juggle or the entire realm of Aerial Art, where you require some kind of apparatus rigged to the ceiling (e.g. Straps, Silks, Hoop, Trapeze, Chinese Pole etc.)
