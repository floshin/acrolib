...
* **Acrobatics**, literally "walking on tip toes", generally describes movement that is especially elegant and virtuous, including high degrees of balance, dynamics, flexibility and strength as well as a performance art of displaying these acrobatic moves in the context of shows or competitions in *Acrobatic Gymnastics*. A person that practices and/or performs Acrobatics and/or competes in *Acrobatic Gymnastics* in particular and/or performs acrobatics professionally, is called an "Acrobat". Acrobatics as a general term covers many different disciplines, since *acrobatic* is assigned as an attribute to various practices to connote extraordinary physical control. 
* **Acrobatic Disciplines** are all the various disciplines that are defined as "acrobatic" due to their especially virtuous nature and display of extraordinary physical control regarding unusual strength and/or flexibility and/or balance and/or coordination. Many of these disciplines contain external apparata or external objects. Rope-Walkers require a rope, Aerialists require some kind of apparatus rigged to the ceiling (e.g. Straps, Silks, Hoop, Trapeze, Chinese Pole etc.), XY require Apparata on the floor (...), Handbalancers most often use *Canes* to balance on, Equilibrists balance external things and the entire area of "Object Manipulation" obviously requires objects (such as in all the different forms of juggling). Skateboarding is an example for an acrobatic discipline in which the acrobat works with both an Apparatus and manipulates an object at the same time. But there are a few acrobatic disciplines that do not contain any external object nor apparatus. It is them we focus on in this project, because *Acrobatic Gymnastics* as a sport is a mixture of these disciplines; these disciplines require nothing but the body of an acrobat when working individually or the bodies of two or more acrobats when working together. 
  * **Floor Acro** consists of acrobatic motions that are performed individually on the floor with nothing but the body; the movement can be choreographed or improvised or be a mixture of both. 
